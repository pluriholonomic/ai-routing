...
| 2026-07-17 11:04 / `d4d2b19`, audit `29575626677` | H81 first-access preservation | Prevent a paper-renderer failure after the irreversible marker from stranding the raw first result | Gate closed at 94 blocks (34/31/29); `outcomes_queried=false` | The strict presentation validator still blocks promotion, but the one-shot wrapper records the error, preserves the raw marker-bound bundle, and forbids automatic outcome re-query. The planted identity failure and full 574-test suite pass. Exact-head audit pinned revision `df74e296`; artifact SHA-256 is `887dea5e10e9e89905b101cf5d253dadfc4f1991f50e15f8b6ed95962ddd1ad3`. |
