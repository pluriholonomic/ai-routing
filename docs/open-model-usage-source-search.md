...
| Uniswap historical tick/position depth | Full historical position reconstruction still needs an archive source or a pinned subgraph. | The hourly monitor has finalized swaps, six-point official QuoterV2 fixed-notional simulations, and sparse 100/500-bps price-impact capacity lower bounds; keep the full depth gate closed because these are not a reconstructed tick book or historical market-wide depth. |
