...
cover every state--action pair and reach the all-low state within 901 steps,
yet none of the 19 failures reaches depth five after step 100,000.  Ordered
batch Bellman sweeps on the same observed transitions recover the rational cut
in 20/20 seeds.  The intervention reverses beyond the rational boundary,
