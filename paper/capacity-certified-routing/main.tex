...
This paper isolates that distinction. It makes seven contributions.
\begin{enumerate}
...
causal label. The running H80/H81 randomizations and outcome-masked H83 future
holdout make those unresolved claims falsifiable without pooling discovery and
confirmation data.
