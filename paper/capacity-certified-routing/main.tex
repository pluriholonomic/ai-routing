...
identify a value-indexed delegation frontier. In a fixed-order pilot of 96
...
\begin{enumerate}
  ...
  value-indexed policy frontier. A 96-block pilot reveals a large displayed-
  quote firmness gap; a prospective randomization separates policy from the
  pilot's fixed-order confound.
\end{enumerate}
