...
separately preregistered enforcement-stress trial does enroll: its first remote
run randomizes eight of eight hot-model blocks across low-stress, high-stress,
and default routing. Those arm outcomes remain masked.
...
Randomized enforcement policy & first support run: 8 eligible hot-model blocks; outcomes masked & feasibility and assignment support only \\
...
The first remote support run enrolls all eight evaluated models and sends eight
requests: one low-stress, three high-stress, and four default assignments.
Twelve distinct providers enter the candidate pairs. The median stress gap is
0.541 while the median high/low price ratio is 1.000. The isolated artifact
passes seed replay and pinned compliance, but provider dominance is 25\% and
all duration, arm-count, model, and provider-diversity gates remain open. No
arm success, rejection, latency, selected-provider, or cost result is released.
