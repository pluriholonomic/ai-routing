...
firmness design with an interim block screen, one mechanism audit, and a timing-
coarsening identification result.
...
PM1 and BM1--BM4 under both calendar cutoffs, canonicalizes every table, records
