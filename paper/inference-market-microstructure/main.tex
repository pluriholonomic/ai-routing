...
leader.  The combined evidence supports a dealer-and-
...
reaction-rule evidence do not identify the mechanism.}
\label{fig:bmaudit}
\end{figure}
...
The proof is constructive and appears in \cref{app:coarsening-proof}.  The result
...
Literal front-running & Proposition~\ref{prop:coarsening} rules out public point identification & Cross-user order and quote-update sequence & Negotiated router/provider event logs \\
